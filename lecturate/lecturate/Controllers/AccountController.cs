    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult Manage(ManageMessageId? message)
        {
            ViewBag.StatusMessage =
                ...
                : message == ManageMessageId.SetPasswordSuccess ? "הסיסמא אותחלה."
                : message == ManageMessageId.RemoveLoginSuccess ? "כניסה החיצונית הוסרה."
                : message == ManageMessageId.Error ? "צצה תקלה."
                : "";
